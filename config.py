...
INPUT_FILE = 'data/symptoms_boolean.csv'
APRIORI_OUTPUT = "data/apriori_output.json"
APRIORI_INPUT = "data/apriori_symptoms.csv"
OUTFILE2 = "data/symptoms_and_diseases.csv"
min_support = 0.15
min_confidence = 0.6
NO_OF_DUPLICATES = 10